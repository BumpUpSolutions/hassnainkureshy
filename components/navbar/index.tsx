...
const Navbar = () => {
  ...
  return (
    <div>
      <button className="p-4 text-white bg-orange-500 sm:hidden" onClick={() => setIsOpen(!isOpen)}>
        {/* Hamburger Icon */}
      ...
      <div className={`fixed inset-y-0 left-0 z-10 flex flex-col w-64 p-4 bg-gray-700 text-white transition duration-300 transform navbar ${isOpen ? 'translate-x-0' : '-translate-x-full'} sm:translate-x-0`}>
